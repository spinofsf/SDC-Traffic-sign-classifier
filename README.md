...
Note that even though certain types of image classification problems(OCR etc.) using DL has easily exceeded human accuracy, the case of traffic signs under real world scenarios is more involved due to the unpredictability in real world scenarios which include different lighting conditions, wear & tear on signage and other physical obstacles. 
